...
import stylesCss from 'themes/ProjetEncheres/styles.css?inline';
...
import vaadinButtonCss from 'themes/ProjetEncheres/components/vaadin-button.css?inline';
import vaadinPasswordFieldCss from 'themes/ProjetEncheres/components/vaadin-password-field.css?inline';
import vaadinTextAreaCss from 'themes/ProjetEncheres/components/vaadin-text-area.css?inline';
import vaadinTextFieldCss from 'themes/ProjetEncheres/components/vaadin-text-field.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_ProjetEncheres_componentCss']) {
    registerStyles(
      'vaadin-button',
    ...
    document['_vaadintheme_ProjetEncheres_componentCss'] = true;
  }
